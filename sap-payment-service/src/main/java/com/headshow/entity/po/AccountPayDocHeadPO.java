...
@AllArgsConstructor
@NoArgsConstructor
public class AccountPayDocHeadPO {
    ...
    //明细表1
    private List<AccountPayDocItemPO> item;

    //明细表
    private List<AccountPayDocSkdwItemPO> skdwItem;

    //附件表
    private List<AccountPayDocAttItemPO> attitem;
